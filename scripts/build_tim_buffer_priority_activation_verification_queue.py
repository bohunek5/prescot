#!/usr/bin/env python3
"""Merge priority Prescot workflow results into a read-only verification queue."""
...
QUEUE_PATH = DATA / "buffer-priority3-activation-queue-2026-09-01.json"
OUTPUT_PATH = DATA / "buffer-priority3-activation-verification-queue-2026-09-01.json"
REPORT_PATHS = [
    DATA / "buffer-priority3-activation-pilot-live-2026-09-01.json",
    DATA / "buffer-priority3-activation-next2-live-2026-09-01.json",
]
