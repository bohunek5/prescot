#!/usr/bin/env python3
"""Build the activation queue for three completed Prescot 24EC320 IP67 cards."""
...
EPREL_QUEUE_PATH = DATA / "buffer-eprel-ip67-family3-queue-2026-09-01.json"
EPREL_VERIFY_PATH = DATA / "buffer-eprel-ip67-family3-final-postverify-2026-09-01.json"
OUTPUT_PATH = DATA / "buffer-ip67-priority3-activation-queue-2026-09-01.json"
