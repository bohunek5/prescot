#!/usr/bin/env python3
"""Merge the IP67 activation results into a read-only verification queue."""
...
QUEUE_PATH = DATA / "buffer-ip67-priority3-activation-queue-2026-09-01.json"
OUTPUT_PATH = DATA / "buffer-ip67-priority3-activation-verification-queue-2026-09-01.json"
REPORT_PATHS = [
    DATA / "buffer-ip67-priority3-activation-pilot-live-2026-09-01.json",
    DATA / "buffer-ip67-priority3-activation-next2-live-2026-09-01.json",
]
...
report = {
    ...
    "sourceWorkflowReports": [str(path) for path in REPORT_PATHS],
    "counts": {
        "total": len(items),
