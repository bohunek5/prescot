...
assert.match(wcobTimText, /Kod producenta:\s*24WCOB320WW5IP62/i);
...
console.log("TIM: definicja, zastosowanie, parametry w punktach i wskazówki instalacyjne; bez tabeli danych.");
console.log("EH007: zastosowanie niebieskiej taśmy, parametry i porady montażowe.");
