...
assert.match(sShapeTimText, /Do czego służy i gdzie użyć tej taśmy LED/i);
assert.match(sShapeTimText, /Wskazówki dla instalatora/i);
...
assert.doesNotMatch(wcobTimText, /Taś000753/i);
...
assert.doesNotMatch(economicBlueTimText, /EH007-050-8-B|5901885261386|Opis dla TIM\.pl|Dane techniczne|Indeks handlowy|Producent\s*:|EAN\s*:/i);
...
console.log("TIM: bez tabeli i bez powtórzonej identyfikacji; opisy zawierają wyłącznie zastosowanie oraz wskazówki dla instalatora.");
console.log("EH007: zastosowanie niebieskiej taśmy i porady montażowe bez danych karty produktu.");
