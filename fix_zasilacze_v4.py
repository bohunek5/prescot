...
models_data = {
    'PR-MAD36-1224': {'power': 36, 'safe': 28, 'dim': '145 × 50 × 29 mm'},
    'PR-MAD60-1224': {'power': 60, 'safe': 48, 'dim': '145 × 50 × 29 mm'},
    'PR-MAD100-1224': {'power': 100, 'safe': 80, 'dim': '176 × 50 × 29 mm'},
    'PR-MAD150-1224': {'power': 150, 'safe': 120, 'dim': '199 × 50 × 29 mm'},
    'PR-MAD200-1224': {'power': 200, 'safe': 160, 'dim': '218 × 50 × 29 mm'},
    'PR-MAD300-1224': {'power': 300, 'safe': 240, 'dim': '240 × 50 × 29 mm'},
}
...
<div style="font-family: inherit; min-height: 190px; padding: 18px; margin: 0; background: none !important; background-color: transparent !important; border: 1px solid currentColor; border-radius: 12px; box-shadow: none !important; color: inherit; display: flex; flex-direction: column;">
<strong style="font-family: inherit; display: block; color: inherit !important; font-size: 15px; line-height: 1.35; margin-bottom: 6px; font-weight: bold;">Jak dobrać zasilacz LED do źródła światła?</strong>
<small style="font-family: inherit; display: block; color: inherit !important; opacity: .76; font-size: 12px; line-height: 1.4; margin-bottom: 15px;">moc urządzenia, zapas mocy i napięcie</small>
...
<p style="font-family: inherit; margin: 0; background: none !important; background-color: transparent !important; color: inherit !important; opacity: .82; font-size: 14px; line-height: 1.65;">Przy zachowaniu bezpiecznego zapasu (ok. 80% mocy znamionowej, czyli ok. <strong style="color: inherit;">{s}W</strong> ciągłego, bezawaryjnego obciążenia), zasilacz ten doskonale sprawdzi się do zasilania systemów oświetleniowych, opraw meblowych, modułów LED czy innych urządzeń wymagających stabilnego napięcia 12V lub 24V. Pamiętaj, żeby nie przeciążać urządzenia i cieszyć się latami bezproblemowej pracy.</p>
</section>
...
<ul>
<li>Moduł samodzielnie detektuje i dostosowuje napięcie wyjściowe (12V lub 24V) do podłączonego oświetlenia LED! Koniec z pomyłkami i spalonymi modułami przy montażu.</li>
...
<ul>
<li>Przy zachowaniu bezpiecznego zapasu (ok. 80% mocy znamionowej, czyli ok. {s}W ciągłego, bezawaryjnego obciążenia), zasilacz ten doskonale sprawdzi się do zasilania systemów oświetleniowych, opraw meblowych, modułów LED czy innych urządzeń wymagających stabilnego napięcia 12V lub 24V.</li>
</ul>
...
<ul>
<li>W przypadku podłączania bardzo krótkich odcinków (poniżej 1 metra), zaleca się ręczne ustawienie stałego napięcia na zasilaczu (12V lub 24V) za pomocą dedykowanych pinów.</li>
</ul>
</section>"""
...
for model, data in models_data.items():
    ...
    # 2. TIM
    tim_html = build_styled_html(model, data, "#e94b25", "Opis techniczny", f"{model} - zasilacz do zaawansowanych instalacji")
...
print("Updated index.html successfully with V4.")
